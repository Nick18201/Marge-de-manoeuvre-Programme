# Syllabus Complet du Programme MDM

Ce document présente la structure détaillée et le contenu pédagogique du programme d'accompagnement.

---

## 📅 PHASE 1 : PRÉLIMINAIRE

### **Séance 1 : Analyse de la Demande & Alliance**
*   **Durée :** 1h
*   **Objectif :** Poser le cadre de l'accompagnement, valider l'engagement du bénéficiaire et comprendre ses enjeux actuels ("l'ici et maintenant") tout en initiant une dynamique de projection.
*   **Contenu Clé :**
    *   **Ice Breaker :** Le jeu des émotions.
    *   **Philosophie "Commencer par la fin" :** Projection immédiate vers le futur pour définir le cap.
    *   **La Vision "Boule à Facettes" :** Structuration des objectifs selon 4 axes (Personnel, Professionnel, Équilibre Pro/Perso, Hiérarchie).
...
## 🔍 PHASE 2 : INVESTIGATION & INTROSPECTION

### Étape 1 : Racines & Trajectoire

#### **Séance 2 : Rétroviseur - Parcours & Héritages**
*   **Durée :** 1h
...
*   **🎒 Travail Inter-Session (Pour S3) :**
    ...
    *   **360° Bienveillant :** Envoyer le questionnaire à 4-6 proches pour recueillir leur perception (Forces, Talents, Zones d'effort).
    *   **Image du Travail :** Associer 5 mots au travail (Vision actuelle vs Vision désirée).
    *   **Interview Passion :** Échanger 20 min avec un professionnel passionné par son métier.

### Étape 2 : Identité & Moteurs

#### **Séance 3 : Personnalité & Moteurs (MBTI)**
*   **Durée :** 1h
...
#### **Séance 4 : Valeurs, Croyances & Psychologie Financière**
*   **Durée :** 1h30
*   **Objectif :** Diagnostiquer et transformer le rapport à l'argent et à la légitimité pour lever les freins inconscients au projet professionnel.
*   **Contenu Clé :**
...
*   **🎒 Travail Inter-Session (Pour S5) :**
    ...
    *   **Lettre à l'Argent :** Finaliser la deuxième partie de la lettre (Réponse ou Nouveau Contrat).
    *   **Ouverture :** Commencer à identifier des pistes professionnelles potentielles à explorer.

---

## 🚀 PHASE 3 : EXPLORATION & PROJECTION

### Étape 3 : Enquêtes Terrain

#### **Séance 5 : Ouverture des Possibles & Stratégie d'Enquête**
*   **Durée :** 1h
*   **Objectif :** Ouvrir le champ des possibles sans censure (divergence) puis structurer la confrontation au réel via des enquêtes métiers.
*   **Contenu Clé :**
    *   **Brainstorming Design Thinking :** Génération d'idées (Crazy 8s) et vérification de l'alignement (Personnalité/Valeurs).
    *   **Stratégie d'Enquête :** Passage à une posture de "Recherche Utilisateur". Préparation des scripts et ciblage des interlocuteurs.
*   **🎒 Travail Inter-Session (Pour S6) :**
    *   **Enquêtes Terrain :** Réaliser 2 à 3 entretiens réseaux avec des professionnels des métiers visés.
    *   **Recherche Documentaire :** Identifier les formations, les financements et le marché caché.

#### **Séance 6 : Retour d'Enquêtes & Faisabilité**
*   **Durée :** 1h
...
### **Séance 7 : Synthèse & Plan d'Action**
*   **Durée :** 1h
...
*   **🎒 Travail pour les 6 mois à venir :**
    *   **Mise en oeuvre :** Exécution du Plan d'Action.

---

## 📈 SUIVI

### **Séance 8 : Bilan à 6 Mois**
*   **Durée :** 1h
*   **Objectif :** Assurer le suivi post-bilan, analyser les écarts entre le plan et la réalisation, et réajuster la trajectoire si nécessaire.
*   **Contenu Clé :**
    *   **Point d'Avancement :** État des lieux des actions réalisées vs en stand-by.
    *   **Analyse des Écarts :** Identification des succès et compréhension des freins (procrastination, peurs).
    *   **Réajustement :** Mise à jour de la feuille de route pour les 6 mois suivants.
